...
if __name__ == "__main__":
    ...
    log_path = os.path.join("results", f"planners_runner_{timestamp}.log")
    ...
    try:
        ...
        # Save results to a file with current date and time in the name
        output_path = f"results/new_dataset_results_{timestamp}.json"
